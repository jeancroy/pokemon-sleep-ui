...
import {TeamMemberFilledSlotProps, TeamMemberViewDataProps} from '@/components/shared/team/memberView/type';
...
> = TeamMemberViewDataProps & TeamMemberFilledSlotProps<TKey, TMember, TConfig, TTeam, TSetup> & {
