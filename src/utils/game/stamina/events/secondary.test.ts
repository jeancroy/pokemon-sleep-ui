...
describe('Stamina / Event Log (+Secondary)', () => {
  ...
  it('is correct with > 1 recovery rate under optimistic', () => {
    ...
    expect(logs[0].staminaUnderlying.after).toBe(141);
    expect(logs[1].type).toBe('sleep');
    expect(logs[1].timing).toBe(25200);
    expect(logs[1].stamina.before).toBe(99);
    expect(logs[1].stamina.after).toBe(99);
    expect(logs[1].staminaUnderlying.before).toBe(99);
    expect(logs[1].staminaUnderlying.after).toBe(99);
    expect(logs[2].type).toBe('wakeup');
    expect(logs[2].timing).toBe(30600);
    expect(logs[2].stamina.before).toBe(90);
    expect(logs[2].stamina.after).toBe(112);
    expect(logs[2].staminaUnderlying.before).toBe(90);
    expect(logs[2].staminaUnderlying.after).toBe(112);
    expect(logs[3].type).toBe('sleep');
    expect(logs[3].timing).toBe(63000);
    expect(logs[3].stamina.before).toBe(58);
    expect(logs[3].stamina.after).toBe(58);
    expect(logs[3].staminaUnderlying.before).toBe(58);
    expect(logs[3].staminaUnderlying.after).toBe(58);
    expect(logs.length).toBe(4);
  });
  ...
  it('is correct with < 1 recovery rate under optimistic', () => {
    ...
    expect(logs[0].staminaUnderlying.after).toBe(101);
    expect(logs[1].type).toBe('sleep');
    expect(logs[1].timing).toBe(25200);
    expect(logs[1].stamina.before).toBe(59);
    expect(logs[1].stamina.after).toBe(59);
    expect(logs[1].staminaUnderlying.before).toBe(59);
    expect(logs[1].staminaUnderlying.after).toBe(59);
    expect(logs[2].type).toBe('wakeup');
    expect(logs[2].timing).toBe(30600);
    expect(logs[2].stamina.before).toBe(50);
    expect(logs[2].stamina.after).toBe(65);
    expect(logs[2].staminaUnderlying.before).toBe(50);
    expect(logs[2].staminaUnderlying.after).toBe(65);
    expect(logs[3].type).toBe('sleep');
    expect(logs[3].timing).toBe(63000);
    expect(logs[3].stamina.before).toBe(11);
    expect(logs[3].stamina.after).toBe(11);
    expect(logs[3].staminaUnderlying.before).toBe(11);
    expect(logs[3].staminaUnderlying.after).toBe(11);
    expect(logs.length).toBe(4);
  });
  ...
  it('is correct with < 1 recovery rate and awake for 50400 secs', () => {
    ...
    expect(logs[0].type).toBe('wakeup');
    expect(logs[0].timing).toBe(0);
    expect(logs[0].stamina.after).toBe(91);
    expect(logs[0].staminaUnderlying.after).toBe(91);
    expect(logs[1].type).toBe('sleep');
    expect(logs[1].timing).toBe(18000);
    expect(logs[1].stamina.before).toBe(61);
    expect(logs[1].stamina.after).toBe(61);
    expect(logs[1].staminaUnderlying.before).toBe(61);
    expect(logs[1].staminaUnderlying.after).toBe(61);
    expect(logs[2].type).toBe('wakeup');
    ...
    expect(logs[2].staminaUnderlying.after).toBe(53);
    expect(logs[3].type).toBe('sleep');
  ...
  it('is correct with < 1 recovery rate and awake for 56400 secs', () => {
    ...
    expect(logs[0].type).toBe('wakeup');
    expect(logs[0].timing).toBe(0);
    expect(logs[0].stamina.after).toBe(75);
    expect(logs[0].staminaUnderlying.after).toBe(75);
    expect(logs[1].type).toBe('sleep');
    ...
    expect(logs[2].stamina.before).toBe(23);
    expect(logs[2].stamina.after).toBe(43);
    expect(logs[2].staminaUnderlying.before).toBe(23);
    expect(logs[2].staminaUnderlying.after).toBe(43);
    expect(logs[3].type).toBe('sleep');
  ...
  it('is correct with < 1 recovery rate and awake for 62400 secs', () => {
    ...
    expect(logs[0].staminaUnderlying.after).toBe(59);
    expect(logs[1].type).toBe('sleep');
    ...
    expect(logs[2].staminaUnderlying.after).toBe(17);
    expect(logs[3].type).toBe('sleep');
    expect(logs[3].timing).toBe(69600);
    expect(logs[3].stamina.before).toBe(0);
    expect(logs[3].stamina.after).toBe(0);
    expect(logs[3].staminaUnderlying.before).toBe(-37);
    expect(logs[3].staminaUnderlying.after).toBe(-37);
    expect(logs.length).toBe(4);
  });
  ...
  it('is correct with < 1 recovery rate and awake for 68400 secs', () => {
    ...
    expect(logs[1].stamina.before).toBe(0);
    expect(logs[1].stamina.after).toBe(0);
    expect(logs[1].staminaUnderlying.before).toBe(-16);
    expect(logs[1].staminaUnderlying.after).toBe(-16);
    expect(logs[2].type).toBe('wakeup');
    expect(logs[2].timing).toBe(43200);
    expect(logs[2].stamina.before).toBe(0);
    expect(logs[2].stamina.after).toBe(20);
    expect(logs[2].staminaUnderlying.before).toBe(-28);
    expect(logs[2].staminaUnderlying.after).toBe(-8);
    expect(logs[3].type).toBe('sleep');
    expect(logs[3].timing).toBe(75600);
    expect(logs[3].stamina.before).toBe(0);
    expect(logs[3].stamina.after).toBe(0);
    expect(logs[3].staminaUnderlying.before).toBe(-62);
    expect(logs[3].staminaUnderlying.after).toBe(-62);
    expect(logs.length).toBe(4);
  });
  ...
  it('allows total recovery amount go beyond 100 with recovery rate up', () => {
    ...
    expect(logs[0].type).toBe('wakeup');
    expect(logs[0].timing).toBe(0);
    expect(logs[0].stamina.after).toBe(73);
    expect(logs[0].staminaUnderlying.after).toBe(73);
    expect(logs[1].type).toBe('sleep');
    expect(logs[1].timing).toBe(28800);
    expect(logs[1].stamina.before).toBe(25);
    expect(logs[1].stamina.after).toBe(25);
    expect(logs[1].staminaUnderlying.before).toBe(25);
    expect(logs[1].staminaUnderlying.after).toBe(25);
    expect(logs[2].type).toBe('wakeup');
    expect(logs[2].timing).toBe(45000);
    expect(logs[2].stamina.before).toBe(0);
    expect(logs[2].stamina.after).toBe(63);
    expect(logs[2].staminaUnderlying.before).toBe(-2);
    expect(logs[2].staminaUnderlying.after).toBe(61);
    expect(logs[3].type).toBe('sleep');
    expect(logs[3].timing).toBe(72000);
    expect(logs[3].stamina.before).toBe(18);
    expect(logs[3].stamina.after).toBe(18);
    expect(logs[3].staminaUnderlying.before).toBe(16);
    expect(logs[3].staminaUnderlying.after).toBe(16);
    expect(logs.length).toBe(4);
  });
